...
class TestReportGenerator:
    ...
    def test_generate_all_reports(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_csv_report_structure(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_csv_report_filename(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_csv_report_empty_discrepancies(self, generator, temp_output_dir, perfect_reconciliation_result):
    ...
    def test_json_report_structure(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_json_report_metadata(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_json_report_summary_data(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_json_report_filename(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_executive_summary_content(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_executive_summary_metrics(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_calculate_financial_impact_values(self, generator, sample_reconciliation_result):
    ...
    def test_compliance_status_compliant(self, generator, perfect_reconciliation_result):
    ...
    def test_generate_recommendations_with_discrepancies(self, generator, sample_reconciliation_result):
        """Test recommendations when discrepancies exist"""
        recommendations = generator._generate_recommendations(sample_reconciliation_result)

        assert "Review and reprocess" in recommendations
        assert "24 hours" in recommendations

    def test_generate_recommendations_no_discrepancies(self, generator, perfect_reconciliation_result):
        """Test recommendations when no discrepancies"""
        recommendations = generator._generate_recommendations(perfect_reconciliation_result)
    ...
    def test_decimal_serialization_in_json(self, generator, temp_output_dir, sample_reconciliation_result):
        ...
        assert isinstance(data['reconciliation_summary']['total_discrepancy_amount'], (int, float))
        assert isinstance(data['financial_impact']['total_volume'], (int, float))

    def test_csv_preserves_decimal_precision(self, generator, temp_output_dir, sample_reconciliation_result):
    ...
    def test_generate_reports_with_different_processors(self, generator, temp_output_dir):
    ...
    def test_executive_summary_formatting(self, generator, temp_output_dir, sample_reconciliation_result):
