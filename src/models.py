...
class Settings(BaseSettings):
    ...
    DB_URL: Optional[str] = Field(None, description="Database connection URL (overrides individual params)")
    
    # AWS Configuration
    AWS_ACCESS_KEY_ID: Optional[str] = Field(None, description="AWS access key ID")
    AWS_SECRET_ACCESS_KEY: Optional[str] = Field(None, description="AWS secret access key")
    AWS_S3_BUCKET_NAME: Optional[str] = Field(None, description="AWS S3 bucket name")
    AWS_BUCKET_NAME: Optional[str] = Field(None, description="AWS S3 bucket name (alias)")
    ...
    PROCESSOR_API_BASE_URL: str = Field(
        ...
        description="Base URL for processor API"
    )
    ...
    REPORT_OUTPUT_DIR: Path = Field(
        ...
        description="Directory for report outputs"
    )
